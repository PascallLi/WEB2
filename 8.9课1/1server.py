...
while True:
    ...
    print(request)    # header的第一行是客户端发出的请求'GET / HTTP/1.1\r\nhost：XX\r\n\r\n'
    line = request.split('\n')[0]  # split 为分隔符对字符串进行切片，默认为‘ ’切片
    print('line', line)    # line GET / HTTP/1.1
    path = line.split()[1]
    print('path, ', path)  # path /
    # 用 sendall 把响应数据发送给客户端
    normal_response = b'zheng sheng biao!'
    doge_response = b'HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\nzheng sheng biao!<img src="img/doge0.gif"><img src="img/doge1.gif">'
    if path == '/doge':
        r = doge_response
