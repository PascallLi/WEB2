...
class Todo(db.Model,ModelHepler):
    __tablename__ = 'todos'
    # 下面是字段定义
...
class User(db.Model,ModelHepler):
    __tablename__ = 'users'
    # 下面是字段定义
    id = db.Column(db.Integer, primary_key=True)
...
class Weibo(db.Model, ModelHepler):
...
class Comment(db.Model, ModelHepler):
